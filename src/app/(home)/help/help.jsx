                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      click &ldquo;More ..., Edit Table&rdquo; on the dropdown
                      menu in the navigation bar at the top of the page. This
                      opens a browser tab with the Google Sheets spreadsheet.
                      The sheet with your table, named with your GHIN number,
                      should be open. If not, find your GHIN number in the list
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      you set a player&apos;s default tee. Do not just use a
                      blank cell and type in the tee name. When you have
                      finished editing your table, use the browser&apos;s back
                      button to return to the app, where your player list will
                      be refreshed automatically. If you do not use the
                      browser&apos;s back button, you may have to sign out and
                      sign in again to refresh your player list.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      an underscore, e.g., &ldquo;Working_Men&apos;s&rdquo;. If
                      you add a dummy group at the right end of the columns,
                      named &ldquo;Walk&rdquo;, the app will let you show in
                      your lineup whether or not a player walks, which is useful
                      if you try to put walkers together and riders together.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      click &ldquo;More ..., Lookup GHIN Information&rdquo; on
                      the dropdown menu in the navigation bar at the top of the
                      page.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      don&apos;t know a guest&apos;s GHIN number, then use
                      ...
                      &ldquo;Last_Name&rdquo; column, e.g., &ldquo;Doe,
                      John&rdquo;, &ldquo;John Doe&rdquo;, etc. If you want to
                      add more than one guest, use the next consecutive dummy
                      value (e.g., 9999992) and so on.{'  '}
                      <span style={{ fontWeight: 'bold' }}>
                        If you know your guest&apos;s index
                      </span>
                      {', '}
                      then you may put it in parenthesis after the guest&apos;s
                      name, preceded by M for a man or W for a woman, e.g., John
                      Guest (M6.4) or Jane Guest (W12.2). If you don&apos;t
                      enter an index for a guest with a dummy GHIN number, your
                      guest will appear with &ldquo;(no index)&rdquo; after his
                      or her name. You can then set a manual course handicap for
                      the guest (see below). Whether or not you know the GHIN
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      guest&apos;s name, preceded by CM for a man or CW for a
                      woman, e.g., John Guest (CM012345) or Jane Guest
                      (CW456789).
                      {'  '}
                      <a
                        ...
                        Click here to look up your Canadian guest&apos;s card
                        number.
                      </a>
                      {'  '}
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      threesomes&apos;s team progs or 4 minus 3 to subtract
                      three points per eighteen holes from the foursomes&apos;
                      team progs.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      remove a player, click the player&apos;s name and the
                      player will move back to the left list. If you just want
                      to start over, click Clear. This will remove all players
                      from your lineup. When you have finished adding players,
                      you can choose a sort order, using the dropdown at the
                      bottom of the right list. The sort order determines the
                      order in which players either appear in the list of
                      players to be assigned to teams manually or to be added to
                      teams automatically by the Auto buttons (see below). The
                      default sort order is Alphabetical. The other options are
                      By Handicap and Random. When you click Done, the
                      Add/Delete Players in Lineup box will close.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      selected for the lineup) by clicking the player&apos;s
                      name. To remove one or more players from a team and also
                      from the list of players selected for the lineup, you can
                      click &ldquo;Add/Delete Players&rdquo; and click the
                      player(s) to be removed.
                    </td>
                  </tr>
                  <tr />
                  <tr />
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      on a player&apos;s name to add the player to the team.
                      This will remove the player from the list of unassigned
                      players. To remove a player from a team, click on the
                      player&apos;s name and the player will return to the
                      unassigned list.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      tee choice dropdown to the right of the player&apos;s
                      course handicaps to select it. This choice drives the
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      Click the * at the right end of the player&apos;s row,
                      which will bring up a dropdown of course handicaps. When
                      you select a manual course handicap, it is assigned to the
                      player&apos;s chosen tee. To take a player out of the game
                      (and remove the player from the Team Hcp calculation),
                      select Not In Game. To switch a player back to automatic
                  ...
                  <tr>
                    ...
                    <td className='help-table_text'>
                      ...
                      will be automatically updated using the players&apos;
                      current indexes. When you click the Save Lineup button,
                      you automatically be taken to the Export page. Note that
                      the Save Lineup button will not appear until you have
                      selected a playing date, number of tee times, and link
                      time, added players to your lineup, and populated your
                      teams.
                    </td>
                  </tr>
                  <tr></tr>
                  <tr>
                    ...
                    <td className='help-table_text'>
                      When you have one or more saved Lineups, you&apos;ll see
                      the Saved Lineups box at the top of the page. When you
                      lick on the name of a saved lineup, it will be loaded for
                      editing in the box below, with buttons to Export, Clear,
                      or Delete. Export will take you to the Export page and
                      load the lineup there. Clear will remove the current saved
                      line up and let you create a new lineup, without deleting
                      the saved lineup. Delete will remove the saved lineup from
